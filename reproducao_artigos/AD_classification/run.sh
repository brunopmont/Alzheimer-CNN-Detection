...
# In the following, the parameters are set up in oder to carry out the papiline for model 8 CL with strategy B.
 '
data_path='/mnt/c/Users/Paulo Pires/Desktop/Alzheimer_cnn/Alzheimer-CNN-Detection/reproducao_artigos/AD_classification/1.5T_data/'
saver_path='/mnt/c/Users/Paulo Pires/Desktop/Alzheimer_cnn/Alzheimer-CNN-Detection/reproducao_artigos/AD_classification/Results/rodagem_autor/'


# Data preparation: image pre-processing and data augmentation
# python from_nii_to_npy.py $data_path # converts files from nii to numpy and creates a txt file containing images size information
